...
<body>
  ...
  <div id="mad-page-wrapper" class="mad-page-wrapper">
    ...
    <div dir="ltr" class="rev_slider_wrapper fullscreenbanner-container">
      <div id="rev-slider-2" data-version="5.4.5" class="mad-d-none rev-slider fullscreenabanner">
        <ul>
          <!--================ Slide 1 ================-->
          <li data-transition="fade">
            <!-- MAIN IMAGE -->
            <img src="{{asset('/images/sliide2.jpg')}}" alt="" data-bgposition="top center" data-bgfit="cover"
            ...
            <div
              ...
              data-x="center" data-y="center" data-hoffset="['0', '0', '0', '0']" data-voffset="['-30', '-30', '-30', '-30']"
              data-width="['700', '700', '700', '100%']" data-height="['auto']" data-textAlign="['center']"
              data-color="['#ffffff']" data-fontsize="['72']" data-lineheight="['88']"
              class="tp-caption tp-resizeme tp-layer-section-title">LIVRAISONS 7 jours sur 7
            ...
            <div
              ...
              data-x="center" data-y="center" data-hoffset="['0', '0', '0', '0']" data-voffset="['140', '140', '140', '140']"
              data-width="['700', '700', '700', '100%']" data-textAlign="['center']" class="tp-caption tp-resizeme">
              <div class="btn-set btns-white justify-content-center"><a
                  href="{{route('all')}}" class="btn btn-huge">Commander Maintenant</a></div>
            </div>
            <!--================ End of Layer ================-->
          </li>
          <!--================ End of Slide 1 ================-->
          ...
          <li data-transition="fade">
            <!-- MAIN IMAGE -->
            <img src="images/fb.jpg" alt="" data-bgposition="top center" data-bgfit="cover"
              data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
            <!--================ Layer ================-->
            <div
              data-frames="[{&quot;delay&quot;:400,&quot;speed&quot;:2000,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power4.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1000,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;auto:auto;&quot;,&quot;ease&quot;:&quot;Power3.easeInOut&quot;}]"
              ...
              data-width="['700', '700', '700', '100%']" data-height="['auto']" data-textAlign="['center']"
              data-color="['#ffffff']" data-fontsize="['72']" data-lineheight="['88']"
              class="tp-caption tp-resizeme tp-layer-section-title">Révolution dans l’univers du sushi <br>
              </div>
            <!--================ End of Layer ================-->
            <!--================ Layer ================-->
            <div
          ...
          <li data-transition="fade">
            <!-- MAIN IMAGE -->
            <img src="images/slide.jpg" alt="" data-bgposition="top center" data-bgfit="cover"
              data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
            <!--================ Layer ================-->
            <div
              data-frames="[{&quot;delay&quot;:400,&quot;speed&quot;:2000,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power4.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1000,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;auto:auto;&quot;,&quot;ease&quot;:&quot;Power3.easeInOut&quot;}]"
              ...
              data-width="['700', '700', '700', '100%']" data-height="['auto']" data-textAlign="['center']"
              data-color="['#ffffff']" data-fontsize="['72']" data-lineheight="['88']"
              class="tp-caption tp-resizeme tp-layer-section-title">Nous livrons Paris gratuitement.<br>
             </div>
            <!--================ End of Layer ================-->
            <!--================ Layer ================-->
            <div
      ...
      <div class="container">
        ...
        <div class="mad-section mad-section--stretched mad-colorizer--scheme-color-2 mad-colorizer--scheme-light">
          <div class="mad-colorizer-bg-color">
            <div class="with-svg-item svg-right-side type-2 bottom"><img src="images/word2.png" alt=""></div>
          </div>
          <div class="mad-section-side-title simple align-center">Seulement en 4 étapes</div>
          <h2 class="mad-title align-center">Comment acheter ?</h2>
          <!--================ Icon Boxes ================-->
          <div class="mad-icon-boxes type-2 style-2 item-col-4">
            <div class="mad-col">
              <!--================ Icon Box ================-->
              <article class="mad-icon-box">
                <i class="mad-icon-box-icon"><img class="svg" src="sushi_svg_icons/cart.svg" alt=""></i>
                <div class="mad-icon-box-content">
                  <h6 class="mad-icon-box-title">01. Choisissez votre plat</h6>
            ...
            <div class="mad-col">
              <!--================ Icon Box ================-->
              <article class="mad-icon-box">
                <i class="mad-icon-box-icon"><img class="svg" src="sushi_svg_icons/cards.svg" alt=""></i>
                <div class="mad-icon-box-content">
                  <h6 class="mad-icon-box-title">02. Appelez nous</h6>
            ...
            <div class="mad-col">
              <!--================ Icon Box ================-->
              <article class="mad-icon-box">
                <i class="mad-icon-box-icon"><img class="svg" src="sushi_svg_icons/truck.svg" alt=""></i>
                <div class="mad-icon-box-content">
                  <h6 class="mad-icon-box-title">03.  Votre commande est sur son chemin</h6>
            ...
            <div class="mad-col">
              ...
              <article class="mad-icon-box">
                ...
                <div class="mad-icon-box-content">
                  <h6 class="mad-icon-box-title">04. Profitez de votre repas</h6>
